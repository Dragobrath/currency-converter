...
<div class="container">
    ...
    <form id="form-currency" class="form-currency" role="form">
            ...
            <div class="col-xs-6">
                <select id="currency-from" name="convert-from" data-placeholder="Choose a Currency..." class="chosen-select">
                    <c:forEach items="${feeds}" var="feed">
                    	<option><c:out value="${feed.currencyCode}" /> - <c:out value="${feed.displayName}" /></option>
                    </c:forEach>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-xs-8">
                <input type="text" name="convert-amount" class="form-control" placeholder="Amount to convert">
            </div>
            <div class="col-xs-4">
